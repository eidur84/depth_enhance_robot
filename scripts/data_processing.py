...
def plotoffset(offsets):
    ...
    plt.figure()
    plt.hist(offsets,np.arange(minval,maxval,0.005),color='blue',edgecolor='black',linewidth=1,zorder=3)
    #plt.hist(offsets,np.arange(minval,maxval,0.5),color='blue',edgecolor='black',linewidth=1,zorder=3)
    plt.title("Measured depth distribution in dataset")
